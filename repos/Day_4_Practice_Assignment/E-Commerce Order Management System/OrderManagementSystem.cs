...
namespace Day_4_Practice_Assignment
{
    internal class OrderManagementSystem
    {
        ...
        public void ShowOrderHistory(int orderId)
        {
            ...
            {
                Console.WriteLine($"No status history for Order {orderId}.");
                return;
            }

            Console.WriteLine($"Status History for Order {orderId} (latest first):");
